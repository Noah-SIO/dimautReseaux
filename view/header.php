...
echo "<td><button onclick=\"window.location.href='?act=batList'\" style='background-color: red;'>Accueil</button></td>";
...
echo "<td><button onclick=\"window.location.href='?act=haas'\">Haas</button></td>";
echo "</tr>";
echo "</table>";
echo"<hr>";