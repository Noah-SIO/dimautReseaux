...
if(isset($_POST['change'])){
    ...
    if($nom == "Admin"){
        echo "<map name='image-map'>";
            echo "<area target='' alt='ADM-AC-SS' title='ADM-AC-SS' href='baiefiche.php?id=' coords='89,128,299,214' shape='rect'>";
            echo "<area target='' alt='ADM-AC-R0coul' title='ADM-AC-R0coul' href='baiefiche.php?id=' coords='260,51,462,122' shape='rect'>";
            echo "<area target='' alt='ADM-AC-R0inf' title='ADM-AC-R0inf' href='baiefiche.php?id=' coords='487,49,684,116' shape='rect'>";
            echo "<area target='' alt='ADM-AC-R0vdi' title='ADM-AC-R0vdi' href='baiefiche.php?id=' coords='729,60,926,114' shape='rect'>";
            echo "<area target='' alt='ADM-SR-R0' title='ADM-SR-R0' href='baiefiche.php?id=' coords='876,125,1066,173' shape='rect'>";
            echo "<area target='' alt='ADM-AC-R1' title='ADM-AC-R1' href='baiefiche.php?id=' coords='868,330,1064,394' shape='rect'>";
        echo "</map>";
    }
    if($nom == "C3D"){
        echo "<map name='image-map'>";
    ...
    if($nom == "CROM"){
        echo "<map name='image-map'>";
            echo "<area target='' alt='CROM-AC-B1' title='CROM-AC-B1' href='baiefiche.php?id=' coords='72,177,266,234' shape='rect'>";
            echo "<area target='' alt='CROM-AC-B2' title='CROM-AC-B2' href='baiefiche.php?id=' coords='250,75,439,132' shape='rect'>";
            echo "<area target='' alt='CROM-AC-B3' title='CROM-AC-B3' href='baiefiche.php?id=' coords='480,75,665,128' shape='rect'>";
            echo "<area target='' alt='CROM-AC-B5' title='CROM-AC-B5' href='baiefiche.php?id=' coords='701,75,880,132' shape='rect'>";
            echo "<area target='' alt='CROM-AC-B6' title='CROM-AC-B6' href='baiefiche.php?id=' coords='860,136,1039,183' shape='rect'>";
            echo "<area target='' alt='CROM-AC-B7' title='CROM-AC-B7' href='baiefiche.php?id=' coords='747,411,932,466' shape='rect'>";
            echo "<area target='' alt='CROM-AC-B8' title='CROM-AC-B8' href='baiefiche.php?id=' coords='480,408,659,459' shape='rect'>";
            echo "<area target='' alt='CROM-AC-B9' title='CROM-AC-B9' href='baiefiche.php?id=' coords='244,400,432,460' shape='rect'>";
            echo "<area target='' alt='CROM-AC-Bserv' title='CROM-AC-Bserv' href='baiefiche.php?id=' coords='83,296,268,355' shape='rect'>";
        echo "</map>";
    }
    if($nom == "CDF"){
        echo "<map name='image-map'>";
            echo "<area target='' alt='ADM-AC-B1' title='ADM-AC-B1' href='baiefiche.php?id=' coords='750,409,937,480' shape='rect'>";
            echo "<area target='' alt='ADM-AC-B2' title='ADM-AC-B2' href='baiefiche.php?id=' coords='505,410,691,481' shape='rect'>";
            echo "<area target='' alt='ADM-AC-B3' title='ADM-AC-B3' href='baiefiche.php?id=' coords='262,410,444,498' shape='rect'>";
            echo "<area target='' alt='ADM-AC-B4' title='ADM-AC-B4' href='baiefiche.php?id=' coords='99,305,293,387' shape='rect'>";
        echo "</map>";
    }
    if($nom == "Sarrade et Galtier"){
        echo "<map name='image-map'>";
            echo "<area target='' alt='STA-AC-B6' title='STA-AC-B6' href='baiefiche.php?id=' coords='774,326,926,445' shape='rect'>";
            echo "<area target='' alt='STA-AC-B7' title='STA-AC-B7' href='baiefiche.php?id=' coords='617,407,762,450' shape='rect'>";
        echo "</map>";
    }
    if($nom == "Haas"){
        echo "<map name='image-map'>";
            echo "<area target='' alt='STA-AC-B8' title='STA-AC-B8' href='baiefiche.php?id=' coords='432,400,587,445' shape='rect'>";
        echo "</map>";    
    }
}
